...
<li class="breadcrumb-item active" aria-current="page">Patner With US</li>
</ol>
</nav>
</div>
</div>
...
<input name="phone_no" type="number" class="form-control" id="contact-number" placeholder="Phone number">
</div>
</div>
<div class="col-12 col-lg-4">
<div class="form-group">
