<?php
    ...
    global $db, $general_videos_rows,  $status, $v, $rows, $row;
...
<li class="breadcrumb-item active" aria-current="page">General Message Videos</li>
</ol>
</nav>
</div>
</div>
